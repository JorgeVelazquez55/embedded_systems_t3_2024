...
extern int main( void )
{
	...
	Uart_Init(&UartConfig[0]);
 	...
 	Uart_SetBaudrate(UART_CFG_PHY_CHANNEL0, 4800);
  Uart_SetBaudrate(UART_CFG_PHY_CHANNEL1, 9600);
  Uart_SetBaudrate(UART_CFG_PHY_CHANNEL2, 19200);
  Uart_SetBaudrate(UART_CFG_PHY_CHANNEL3, 57600);
  Uart_SetBaudrate(UART_CFG_PHY_CHANNEL4, 115200);
