...
UINT8 priorityScheduler_Counter ;
UINT8 gpriorityScheduler_Counter ;
...
*****************************************************************************************************/
static const Pin sw0 = PIN_PUSHBUTTON_0;
...
void _ConfigureButtons( void )
{
	...
	PIO_ConfigureIt( &sw0, _Button0_Handler ) ; /* Interrupt on rising edge  */
